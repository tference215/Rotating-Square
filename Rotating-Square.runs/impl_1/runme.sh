...
HD_PWD='D:/Project/Rotating-Square/Rotating-Square.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rotate_square.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rotate_square.tcl -notrace
