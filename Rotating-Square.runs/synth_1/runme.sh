...
HD_PWD='D:/Project/Rotating-Square/Rotating-Square.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rotate_square.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rotate_square.tcl
